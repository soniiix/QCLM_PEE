                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            if (!isset($_GET['editClicked'])) { ?>
                                <button type="submit" value="<?php echo $_SERVER['PHP_SELF'] ?>?editClicked=<?php echo $unProduit['id'] ?>" name="btn-editClicked" class="btn btn-outline-warning"><i class="bi bi-pencil-square"></i></button>
                            <?php } ?>
                        </td>
                    </tr>
            <?php }

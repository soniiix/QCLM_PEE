...
<body id="t">
    ...
    <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
        <div style="font-size: 30px;text-align: center;font-family: Helvetica;">ERREUR !</div>
        <div style="margin-top:5px;text-align:center;color:#8a8a8a;margin-bottom:80px; font-size:.8em;line-height:1.2em;font-family: Georgia;"><a href="http://www.thecodepost.org/internet/play-hidden-t-rex-game-offline-chrome/" target="_blank"></a>Une erreur s'est produite. Veuillez revenir sur ce site depuis celui de l'AFPA</div>
